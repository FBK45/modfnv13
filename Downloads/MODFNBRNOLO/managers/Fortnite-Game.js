        ...
        res.json({
            ...
            "playlistinformation": {
                ...
                "playlist_info": {
                    ...
                    "playlists": [{
                        ...
                        "image": "https://images-ext-1.discordapp.net/external/qIMWoBR5pRbQbBSxur8p6LEHMBJkDGjUBD4Ox8sU1KM/https/cdn2.unrealengine.com/14br-junior-key-art-motd-1920x1080-nomnom-1920x1080-598740931.jpg?width=810&height=456",
                        "playlist_name": "Playlist_Junior_32",
                        "hidden": false,
                        "violator": "",
                        "_type": "FortPlaylistInfo",
                        "description": "Galactus go brrrrrr",
                        "display_subname": "nomnom",
                        "display_name": "nomnom"
                    }, {
                        ...
                        "image": "https://cf-assets.esportsclub.nl/erz7ypidnr7y/2YAk9i7BEY0BsWoVhnX4A0/48ef22951a6425abc316402bee712519/Galactus.jpg",
                        "playlist_name": "Playlist_Junior_32",
                        "hidden": false,
                        "_type": "FortPlaylistInfo"
                    },{
            ...
            "battleroyalenewsv2": {
                "news": {
                    "motds": [{
                        ...
                        "spotlight": false,
                        "websiteURL": "https://discord.gg/PTcu6AzBw4",
                        "websiteButtonTex": "Storm++V2 Discord"
                    }
                ],
                },
                "jcr:isCheckedOut": true,
            ...
            "Creativenewsv2": {
                "news": {
                    "motds": [{
                        "entryType": "Website",
                        "image": Userconfig.news[0].image,
                        "tileImage": Userconfig.news[0].image,
                        "videoMute": false,
                        "hidden": false,
            ...
            "shopCarousel": {
                ...
                "itemsList": {
                    ...
                    "items": [{
                        "tileImage": Userconfig.news[0].title,
                        "fullTitle": Userconfig.news[0].title,
                        "hidden": false,
            ...
            "specialoffervideo": {
                "jcr:isCheckedOut": true,
                "specialoffervideo": {
                    "videoString": Userconfig.videoString, // Literally only this makes the entire thing works (for now I suppose), can be random too.
                    "videoUID": Userconfig.videoUID,
                ...
                "_noIndex": false,
                "jcr:baseVersion": "a7ca237317f1e7994a617c-6fd5-4f16-bff1-e4709ead09ad",
